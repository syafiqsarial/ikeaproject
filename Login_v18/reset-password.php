...
<body bgcolor="#f2e9c9" style="margin-top:0 ;margin-bottom:0 ;margin-right:0 ;margin-left:0 ;padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;background-color:#f2e9c9;">
  <!--[if gte mso 9]>
<center>
<table width="600" cellpadding="0" cellspacing="0"><tr><td valign="top">
<![endif]-->
  <center style="width:100%;table-layout:fixed;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;background-color:#f2e9c9;">
    <div style="max-width:600px;margin-top:0;margin-bottom:0;margin-right:auto;margin-left:auto;">
      <table align="center" cellpadding="0" style="border-spacing:0;font-family:'Poppins-Regular',sans-serif;color:#333333;Margin:0 auto;width:100%;max-width:600px;">
        <tbody>
          <tr>
            <td align="center" class="vervelogoplaceholder" height="143" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;height:143px;vertical-align:middle;" valign="middle"><span class="sg-image" data-imagelibrary="%7B%22width%22%3A%22160%22%2C%22height%22%3A34%2C%22alt_text%22%3A%22Verve%20Wine%22%2C%22alignment%22%3A%22%22%2C%22border%22%3A0%2C%22src%22%3A%22https%3A//marketing-image-production.s3.amazonaws.com/uploads/79d8f4f889362f0c7effb2c26e08814bb12f5eb31c053021ada3463c7b35de6fb261440fc89fa804edbd11242076a81c8f0a9daa443273da5cb09c1a4739499f.png%22%2C%22link%22%3A%22%23%22%2C%22classes%22%3A%7B%22sg-image%22%3A1%7D%7D"><a target="_blank"><img alt="IKEA" height="34" src="../ikea-logo.png" style="border-width: 0px; width: 155px; height: 60px;" width="160"></a></span></td>
          </tr>
          <!-- Start of Email Body-->
          <tr>
            <td class="one-column" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;background-color:#fffcf0;">
              <!--[if gte mso 9]>
                    <center>
                ...
                <tbody>
                  ...
                  <tr>
                    <td class="inner contents center" style="padding-top:15px;padding-bottom:15px;padding-right:30px;padding-left:30px;text-align:left;">
                      <center>
                        <p class="h1 center" style="Margin:0;text-align:center;font-family:'flama-condensed';font-weight:100;font-size:30px;Margin-bottom:26px;letter-spacing: 1.3px"><strong>Forgot your password?</strong></p>
                        <!--[if (gte mso 9)|(IE)]><![endif]-->

                        <p class="description center" style="font-family:'Muli';Margin:0;text-align:center;max-width:320px;color:#a1a8ad;line-height:24px;font-size:13px;Margin-bottom:10px;margin-left: auto; margin-right: auto; letter-spacing: 1px"><span style="color: rgb(161, 168, 173); font-family: Muli, &quot;Arial &quot;, Arial; font-size: 13px; text-align: center; ">That's okay, it happens! Click on the button below to reset your password.</span></p>
                        <!--[if (gte mso 9)|(IE)]><br>&nbsp;<![endif]-->
						
						<form method="post" action="" style="font-family:'Muli';" class="validate-form">
						<br>
						<div class="form-input validate-input" data-validate = "Username is required">
  							<input type="text" class="form-control"  name="email" placeholder="Enter your email.." style="width: 400px; "><br>
						</div>
						<div class="form-input validate-input" data-validate = "Username is required">
							<input type="password" class="form-control"  name="password" placeholder="Enter your new password.." style="width: 400px;">
						</div>
						 <br>
          ...
          <tr>
            <td style="padding-top:0;padding-bottom:0;padding-right:30px;padding-left:30px;text-align:center;Margin-right:auto;Margin-left:auto;">
              <center>
                <p style="font-family:'Muli',Arial,sans-serif;Margin:0;text-align:center;Margin-right:auto;Margin-left:auto;font-size:14px;color:#948757;line-height:23px;letter-spacing: 0.7px">Problems or questions? Call us at
                  <nobr><a class="tel" href="tel:+60379527575" style="color:#948757;text-decoration:none;" target="_blank"><span style="white-space: nowrap">&nbsp;03-7952 7575</span></a></nobr>
                </p>

                <p style="font-family:'Muli',Arial,sans-serif;Margin:0;text-align:center;Margin-right:auto;Margin-left:auto;font-size:14px;color:#948757;line-height:23px;letter-spacing: 0.7px">or email <a href="mailto:customerservice.ikeamy@ikano.asia" style="color:#948757;text-decoration:underline;" target="_blank">customerservice.ikeamy@ikano.asia</a></p>

                <p style="font-family:'Muli',Arial,sans-serif;Margin:0;text-align:center;Margin-right:auto;Margin-left:auto;padding-top:10px;padding-bottom:0px;font-size:13px;color:#948757;line-height:23px;">© Inter IKEA Systems B.V. 1999-2020 </p>
              </center>
            </td>
          </tr>
          <!-- whitespace -->
