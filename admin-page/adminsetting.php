			...
			<div class="col-xl-9 col-lg-7 ">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold" style="color: #152F4F">Profile</h6>
...
//				  echo        '</div>';
				  ...
				  echo					"&emsp;";
				  echo                	"<a href='adminpassword.php' class='btn btn-dark btn-success' style='font-size: 15px; letter-spacing: 0.9px'>Change your password</a>";
				  echo             '</div>';
				  echo       '</div>';
			 ...
			 <div class="col-xl-3 col-lg-5">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold" style="color: #152F4F">Profile Picture</h6>
                </div>
                <div class="card-body">
					<?php
                   ...
                   <div class="text-center">
					...
					<div class="form-group">
				     <div class="col-xs-12"><br>
				       <input type='submit' name='upload' class='btn btn-dark btn-success' style="font-size: 15px; letter-spacing: 0.9px"><i class='glyphicon glyphicon-ok-sign'></i>
				     </div>
				    </div>
				  </div><br>
					</form>
