    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h4 mb-2 text-gray-800">Add Table</h1><hr><br>
			...
			<div class="col-xl-12 col-lg-7 ">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold" style="color: #152F4F">Add Table</h6>
...
function add()
{
  ...
  echo '<br>';
  echo '<input type="submit" name="addTable" value="Add Table" class="btn btn-dark pull-right" >';
  echo '</div></form>';
