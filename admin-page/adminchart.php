  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
		...
		<!-- Nav Item - Charts -->
      <li class="nav-item ">
        <a class="nav-link" href="adminchart2.php">
          <i class="fas fa-fw fa-chart-area"></i>
          <span>Charts 2</span></a>
      </li>
            ...
            <div class="col-xl-9 col-lg-3">
              <div class="card shadow mb-4">
				...
				echo   '<form class="form" action="" method="post" id="registrationForm">';		 
				  ...
				  echo              '<label for="username"><h4>Username</h4></label>';
				  echo            '</div>';
				  echo        '</div>';          
				  echo        '<div class="form-group">';                       
				  echo            '<div class="col-xs-6">';
				  ...
				  echo	'</form>';	
						...
						while ($row = mysqli_fetch_assoc($qry)) {
						  echo '<tbody><tr>';
						  echo '<div class="column">' . $row['username'] .';
						  echo '<td>' . $row['name'] . '</td>';
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                   <div class="text-center">
					<img src="http://ssl.gstatic.com/accounts/ui/avatar_2x.png" class="avatar img-circle img-thumbnail" alt="avatar"><br><br>
