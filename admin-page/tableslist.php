    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h4 mb-2 text-gray-800">Table List</h1><hr><br>
			...
			<div class="col-xl-12 col-lg-7 ">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold" style="color: #152F4F">Table List</h6>
                ...
                <?php
					...
					echo '<a href="tablesadd.php" class="btn btn-dark float-right">Add Table</a> <br>';
					...
					$con=mysqli_connect("localhost","root","root","ikea");
						...
						//$menusIDAlterValue = $row['id'];
                          ...
                          echo "<td> " . $row['tableid'] . "";
                          echo "<td> " . $row['tablepax'] . "";
                         
						  $tableid = $row['tableid'];
						  ///////////////////////////////////// to update menu
						  echo '<td>';
							echo '<form style="display:inline-block" action="updatetable.php" method="post" >';
							echo   "<input type='hidden' value='$tableid' name='tableToUpdate'>";
						  	echo   '<button type="submit" name="updatetable" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i>';
							//echo   '<input type="submit" name="updatetable" value="Update">';
							echo '</form>';
						  //echo '</td>';
						  ///////////////////////////////////// to delete
						  //echo '<td>';
							echo '<form style="display:inline-block" action="process.php" method="post" >';
							echo 	"<input type='hidden' value='$tableid' name='tableToDelete'>";
							echo	'<button type="submit" name="deletetable" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>';
							//echo   '<input type="submit" name="deletetable" value="Delete">';
							echo '</form>';
					      echo '</td>';
